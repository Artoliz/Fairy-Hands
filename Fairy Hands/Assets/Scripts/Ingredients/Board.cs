...
public class Board : MonoBehaviour
{
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            if (collision.gameObject.GetComponent<Ingredient>().State != Ingredient.StateIngredient.InHand)
            {
            ...
            collision.gameObject.GetComponent<Ingredient>().State = Ingredient.StateIngredient.OverBoard;
        }
    }
}
