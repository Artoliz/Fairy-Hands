...
public class AnimatedBookController : MonoBehaviour
{
    ...
    public class PageObjects
    {
        ...
        [System.NonSerialized] public GameObject UiRecto; // Instantiated Ui recto for the current page
        [System.NonSerialized] public GameObject UiVerso; // Instantiated Ui verso for the current page
    }
    ...
    public List<Page> pagesUi = new List<Page>(); // The UI prefabs associated to each pages

    [Tooltip("Adjust quick rotation speed (when double tap is done)")] [Range(1f, 10)]
    public float quickRotationSpeed = 2; // Speed for quick rotation
    ...
    IEnumerator TurnToPreviousPageTransition()
    {
        ...
        {
            bookPages[currentPage % 3].page.localRotation =
                Quaternion.Lerp(pageTurnedRotation, pageUnturnedRotation, t);
            t += Time.deltaTime * speed;
